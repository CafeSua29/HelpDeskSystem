...
namespace HelpDeskSystem.Data.Migrations
{
    ...
    [Migration("20241211061001_fixnotimsg")]
    partial class fixnotimsg
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.AppRole", b =>
                {
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.Reply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.TicketsPriorityView", b =>
                {
                    b.Property<int>("HighTickets")
                        .HasColumnType("int");

                    b.Property<int>("LowTickets")
                        .HasColumnType("int");

                    b.Property<int>("MediumTickets")
                        .HasColumnType("int");

                    b.Property<int>("TotalTickets")
                        .HasColumnType("int");

                    b.ToTable("TicketsPriorityView", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("HelpDeskSystem.Models.TicketsSummaryView", b =>
                {
                    ...
                    b.ToTable("TicketsSummaryView", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.AppRole", b =>
                {
                    b.HasOne("HelpDeskSystem.Models.AppUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("HelpDeskSystem.Models.AppUser", "ModifiedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.AppUser", b =>
                {
                    ...
                    b.HasOne("HelpDeskSystem.Models.AppRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.AuditTrail", b =>
                {
                    b.HasOne("HelpDeskSystem.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.Comment", b =>
                {
                    ...
                    b.HasOne("HelpDeskSystem.Models.Comment", "ReplyComment")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.Reply", b =>
                {
                    b.HasOne("HelpDeskSystem.Models.Comment", "Comment")
                        .WithMany()
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("HelpDeskSystem.Models.AppUser", "ReplyToUser")
                        .WithMany()
                    ...
                    b.HasOne("HelpDeskSystem.Models.AppUser", "UserReply")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDeskSystem.Models.Ticket", b =>
                {
                    b.HasOne("HelpDeskSystem.Models.AppUser", "AssignedTo")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("HelpDeskSystem.Models.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HelpDeskSystem.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
